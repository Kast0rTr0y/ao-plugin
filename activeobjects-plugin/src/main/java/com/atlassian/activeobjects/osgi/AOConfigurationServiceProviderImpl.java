...
public class AOConfigurationServiceProviderImpl implements AOConfigurationServiceProvider
{
    ...
    @Override
    public ActiveObjectsConfiguration generateScannedConfiguration(final Bundle bundle)
    {
    ...
    @Override
    public String getEntityDefaultPackage()
    {
        return ENTITY_DEFAULT_PACKAGE;
    }
    ...
    private List<ActiveObjectsUpgradeTask> scanUpgradeTask(Bundle bundle)
    {
        ...
        final Iterable upgradeClasses = new BundleContextScanner().findClasses(bundleContext, ENTITY_DEFAULT_PACKAGE,
